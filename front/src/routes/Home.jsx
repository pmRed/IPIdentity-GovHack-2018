        ...
        return (
            <Container>
                <Segment style={{ padding: '8em 0em' }} vertical>
                    ...
                    To facilitate rapid querying of our IP database, a custom persistence layer is created locally, which is verification against the blockchain. In this way, users get the best of both worlds: the responsiveness of a local database, and the security of a decentralised blockchain database.
                </Segment>
            </Container>
        )
    }
